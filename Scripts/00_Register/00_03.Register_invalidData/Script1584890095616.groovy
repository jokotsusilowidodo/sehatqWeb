...
CustomKeywords.'ui.input.nameMailPassword'("", "", "")	
...
KeywordUtil.logInfo("Check success Message")
	WebUI.verifyElementPresent(findTestObject('/Page_Login/Email_Login/Page_Register/err_nameBlank'), 60)
	WebUI.verifyElementPresent(findTestObject('/Page_Login/Email_Login/Page_Register/err_emailInvalid'), 60)
	WebUI.verifyElementPresent(findTestObject('/Page_Login/Email_Login/Page_Register/err_invalidPassword'), 60)
	WebUI.takeScreenshot()
